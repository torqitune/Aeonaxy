...
const EmailPage = () => {
    ...
    useEffect(() => {
        axios.post('https://aeonaxy-7.onrender.com/email', { userId })       //making a post request again , sending userID , so in response we get the emailID of the user linekd with userID
            .then(response => {
