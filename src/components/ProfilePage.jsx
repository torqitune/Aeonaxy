...
const ProfilePage = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            const response = await axios.post("http://localhost:8080/profile",{userId , imageUrl , location});         //sending userId (mongoDB) and image (image url of local image) and the location in post request
